...
| [**novel-storyboard**](skills/novel-storyboard/README.en.md) | Storyboarding for AI short drama: new seeds use 5–10s generation segments → 2–5s cuts → one keyframe per cut. Every cut inherits the claimed script beats through `sourceState` before camera direction, rich H3 prompting, and cut/segment continuity are applied. All 20 quality gates script-checked |
