...
密度只管信息预算，不管人物摆得多“完整”。三档共同遵守行为因果：每只可见的手要么承担明确任务，要么自然垂落/受支撑；视线跟随对话对象、当前任务或道具；道具朝使用者、支撑面或实际光源，不为观众可读性正对镜头；允许人物错层、遮挡和不完整露出。角色参考图只锁身份与服装，不能照抄其试镜姿势、视线和手持物。
...
线索可读不等于角色展示线索：卡片、手机、信件等应按人物真实阅读角度倾斜；若镜头需要看清内容，用机位、焦点或插入特写解决，不要让人物把它举到胸前正对镜头。
...
同时做行为验收：有没有正面排队、对称夹住道具、向镜头展示证物、复制 screen-test 手势，或为了“动作前”把已有搬运/承重清空。任一出现都驳回，不得以密度门通过代替人工视觉确认。
